...
insert=Button(root,text="INSERT", bg="blue", fg="white")
insert.place(x=20,y=300)

search=Button(root,text="SEARCH", bg="blue", fg="white")
search.place(x=80,y=300)

update=Button(root,text="UPDATE", bg="blue", fg="white")
update.place(x=148,y=300)

delete=Button(root,text="DELETE", bg="blue", fg="white")
